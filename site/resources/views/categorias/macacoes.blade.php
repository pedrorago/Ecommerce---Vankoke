...
<div class="Produtos-banner">
    <button class="filtro-box" id="filtroBox">
        ...
        <form class="filtro-formulario">
            ...
            <span class="Selects">
                <select id="Tamanho" value="---" onchange="filtros_macacoes()">
                ...
                <select id="Cor" value="---" onchange="filtros_macacoes()">
                    <option >---</option>
                </select>
                <select id="Preco" value="---" onchange="filtros_macacoes()">
                    <option value="all">---</option>
...
<section id="Produtos-catalogo">
    <div class="container">
        <main onload="scroll_macacoes()" class="block">
