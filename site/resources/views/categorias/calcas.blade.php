...
<div class="Produtos-banner">
    <button class="filtro-box" id="filtroBox">
        ...
        <form class="filtro-formulario">
            ...
            <span class="Selects">
                <select id="Tamanho" value="---" onchange="filtros_calcas()">
                ...
                <select id="Cor" value="---" onchange="filtros_calcas()">
                    <option >---</option>
                </select>
                <select id="Preco" value="---" onchange="filtros_calcas()">
                    <option value="all">---</option>
...
<section id="Produtos-catalogo">
    <div class="container">
        <main onload="scroll_calcas()" class="block">
