 <div class="relacionados-container">
    ...
    <div class="produtos-box">
        ...
        <span class="produtos-descricao">
            <a href="/produto/<?= $value['codigo_slug'].'/'.$value['slug']; ?>" alt="produto-nome" title="produto-nome" class="Heading-4"><?= $value['nome']; ?></a>
            <a href="/produto/<?= $value['codigo_slug'].'/'.$value['slug']; ?>" alt="produto-nome" title="produto-nome" class="Display-3 parcelas"><?= $value['preco_dividido']; ?></a>
